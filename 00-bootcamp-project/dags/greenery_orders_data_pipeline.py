...
def _load_data_to_gcs(ds):
    keyfile_gcs = "/opt/airflow/dags/liquid-optics-384501-9b493b36cc81-gcs.json"
...
def _load_data_from_gcs_to_bigquery(ds):
    ...
    blob = bucket.blob(destination_blob_name)
    if blob.exists():
        keyfile_bigquery = "/opt/airflow/dags/liquid-optics-384501-cb732b4da753-bq-n-gcs.json"
